...
const DeviceApprovalPage = () => {
  ...
  // FIXED: Check authentication while loading
  useEffect(() => {
  ...
  // Show spinner WHILE pending (loading)
  if (isPending) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-background">
        <Spinner />
        <p className="mt-4 text-sm text-zinc-400">Loading session...</p>
      </div>
    );
  }

  // If no session after loading, don't render (useEffect will redirect)
        ...
        <div className="space-y-8">
          ...
          <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-8 bg-zinc-900/50 backdrop-blur-sm text-center">
            ...
            <div className="flex justify-center mb-6">
              <div className="w-24 h-24 rounded-2xl border-2 border-dashed border-zinc-600 bg-zinc-800 flex items-center justify-center relative">
            ...
            {/* Device Code Card */}
            <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-6 bg-zinc-900/50 backdrop-blur-sm space-y-4 mt-6">
